                ...
                <div class="col-md-8 col-sm-12">
                    <div class="right-nav">
                        ...
                        <div class="nav-b hidden-xs">
                            <div class="nav-box">
                                <ul>
                                    <li><a href="../../../resources/static/howitworks.html">How it works</a></li>
                                    <li><a href="../../../resources/static/about-us.html">Chamb for Business</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<%--                                    <li><a href="../../../resources/static/howitworks.html">How it works suppliers</a></li>--%>
<%--                                    <li><a href="../../../resources/static/pricing.html">Pricing</a></li>--%>
...
<%--                                <h2>COMPANY</h2>--%>
<%--                                <ul>--%>
<%--                                    <li><a href="../../../resources/static/about-us.html">About chamb</a></li>--%>
